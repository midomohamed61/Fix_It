            ...
            <motion.div className="flex flex-wrap -mx-4 mb-5" variants={itemVariants}>
                ...
                <div className="w-full md:w-1/2 px-4 mb-5">
                    ...
                    <Input
                        ...
                        onChange={handleChange}
                        className={`w-full p-3 border-2 rounded-lg transition-all bg-[#FEF3E2] ${errors.idNumber ? 'border-red-500 animate-shake' : 'border-[#4C7B8B] hover:border-[#EFB036] focus:ring-2 focus:ring-[#EFB036] focus:border-transparent'}`}
                        required
                    />
                    {errors.idNumber && (
                        <motion.p 
